      ...
      <div class="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
        ...
        <div class="flex-1 w-full">
          <div class="flex flex-col sm:flex-row items-center sm:items-center gap-2 sm:gap-3 mb-2">
            ...
            <span :class="userTypeClass" :style="(user?.type || '').toLowerCase().includes('studyseeker') ? { backgroundColor: '#0f2a5f' } : {}">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="info-card group">
              <div class="info-icon-wrapper" :class="user?.isVerified ? 'bg-gradient-to-br from-blue-500 to-blue-600' : 'bg-gradient-to-br from-blue-400 to-blue-500'">
                <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div class="info-content">
                ...
                <span v-if="user?.isVerified" class="info-value text-blue-600 font-semibold flex items-center gap-1">
                  <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                  </svg>
                  Verified
                </span>
                <span v-else class="info-value text-blue-600 font-semibold">Not Verified</span>
              </div>
            </div>
